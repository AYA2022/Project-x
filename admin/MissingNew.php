               ...
               <form   action="?do=inssert" method="POST" enctype="multipart/form-data">
                 <div class="box-body">
                   ...
                   <div class="form-group text-right">
                     ...
                     <div class="form-group">
                       <label for="exampleFormControlTextarea1"> مواصفات / معلومات اضافية</label>
                       <textarea class="form-control" name="Title_lll" id="exampleFormControlTextarea1" rows="2"></textarea>
                     </div>
                     
                     <div class="form-group">
                       <label for="exampleFormControlTextarea1"> مواصفات الملابس التي يرتديها المفقود </label>
                       <textarea class="form-control" name="Title_ll" id="exampleFormControlTextarea1" rows="2"></textarea>
                     </div>
