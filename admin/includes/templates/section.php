...
<!-- ############################################################################ -->
        <div class="col-lg-3 col-xs-6">
          ...
          ?>
            ...
            <div class="icon">
              <img src="styles/dist/img/icon/B.png" width="70" />
            </div>
...
<!-- ############################################################################ -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          ?>
            ...
            <div class="icon">
              <img src="styles/dist/img/icon/W.png" width="70" />
            </div>
            <a class="small-box-footer"></a>
          </div>
        </div>
...
<!-- ############################################################################ -->
        ...
        <!-- ./col -->        
          ...
          ?>
            ...
            <div class="icon">
            <img src="styles/dist/img/icon/66.png" width="70" />
            </div>
            <a class="small-box-footer"></a>
          </div>
        </div>
...
<!-- ############################################################################ -->
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          ?>
            ...
            <div class="icon">
            <img src="styles/dist/img/icon/88.png" width="70" />
            </div>
            <a class="small-box-footer"></a>
          </div>
        </div>
