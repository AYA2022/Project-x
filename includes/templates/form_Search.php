...
<section class="py-5">
  <div class="container">
    ...
    <h1 class="h2 mb-5 text-center">بلاغات في حاله العثور أو الفقد  </h1>
       <h1 class="h2 mb-5 text-right"> فقدت او عثرت بلغ الآن   </h1>
<?php
    if(!empty($formErrors)){
...
<form class="text-right"   action="<?php echo $_SERVER['PHP_SELF']  ?>" method="post" enctype="multipart/form-data">
  <div class="form-row text-right">
    <div class="form-group col-md-12">
      <label for="inputEmail4" class="text-right">اسم الطفل/ة </label>
      <input type="text" name="name" class="form-control" id="inputEmail4" placeholder="أدخل اسم الطفل/ة " required>
    </div>
    </div>
    <div class="form-group text-right">
      <label for="inputAddress">متي تم الاختفاء</label>
      <input type="text" name="Title_l" class="form-control" id="inputAddress" placeholder="أدخل وقت الأختفاء أو العثور" required>
    </div>
    <div class="text-right">
      <label for="inputCity">رقم هاتفك </label>
      <input type="text" name="nmpur" class="form-control" id="inputCity" placeholder="أيرجي أدخال رقم هاتفك " required>
    </div>
    <div class="form-group text-right">
      <label for="inputAddress2">عنوانك </label>
      <input type="text"  name="Title_ll" class="form-control" id="inputAddress2" placeholder="أدخل العنوان بالتفاصيل " required>
    </div>
    <div class="form-group text-right">
    ...
    <div class="form-group text-right">
      <label for="exampleFormControlSelect1">نوع البلاغ</label>
      <select class="form-control" name="question" id="exampleFormControlSelect1">
      <option value="Missing">فقدت</option>
      <option value="Existing">عثرت</option>
      </select>
    </div>
    <div class="form-group text-right text-right">
      <label for="exampleFormControlTextarea1">الملابس الذي يرتديها الطفل/ة ومواصفاته </label>
      <textarea class="form-control" name="Title_lll" id="exampleFormControlTextarea1" rows="3">
      </textarea>
    </div> <br>
    <div class="form-group text-right text-right">
      <label for="exampleFormControlTextarea1">معلومات إضافيه</label>
      <textarea class="form-control" name="Title_lll" id="exampleFormControlTextarea1" rows="3">
      </textarea>
    </div> <br>  
      <div class="text-right">
      <label for="exampleFormControlSelect1">صوره خاصه بالطفل/ة</label>
    </div>
