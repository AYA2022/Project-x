    <section class="d-flex align-items-center dark-overlay bg-cover" style="background-image: url(styles/img/nav/index.jpg);">
      <div class="container py-6 py-lg-7 text-white overlay-content text-center"> 
        <div class="row">
          <div class="col-xl-10 mx-auto">
            <h3 class="display-3 font-weight-bold text-shadow"> أيدك في أيدنا نوصل </h3>
            <p class="text-lg text-shadow"> نعيد الأمل المفقود . </p>
          </div>
        </div>
      </div>
    </section>
  ...
  foreach(getItems() as $row){ 
       // <!-- blog item-->
        ...
        echo' <img class="img-fluid card-img-top" src="admin/data/uploads/imgUser/'.$row['imgUp'].'" alt="..."/></a>';
          if($row['question'] == 'Missing'){ echo"  <span class=' p-2 mb-2 bg-danger text-white text-center'><h5 class='abdooo'> مفقود </h5></span> ";}
            elseif($row['question'] == 'Existing'){ echo"  <span class=' p-2 mb-2 bg-info text-white text-center'><h5 class='abdooo'> شخص ما عثر عليه </h5></span> ";}
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-sm-3 col-md-12">
              ...
              <br><br>
                <h4 class="wow-outer"><span class="wow slideInRight">أنضم لنا وكن ضمن فاعلين االخير </span></h4>
