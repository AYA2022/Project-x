          ...
          <div class="w-100 py-5 px-md-5 px-xl-6 position-relative">
            ...
            <form class="form-validate text-right"  action="<?php echo $_SERVER['PHP_SELF']  ?>" method="post">
              ...
              <div class="form-group">
                ...
                <input class="form-control" name="name"  type="text" placeholder=" enter your name "  pattern=".{4,}" title="يجب ان لا يقل الاسم عن 4 احرف" required >
              </div>  
              ...
              <div class="form-group">
                ...
                <input class="form-control" name="Password"  placeholder="*****" type="password"  pattern=".{6,}" minlength="6" title="يجب ان لا تحتوى كلمه المرور علي اقل من 6 احرف" required >
              </div>
              ...
              <button class="btn btn btn-outline-muted btn-block btn-social mb-3"><i class="fa-2x fa-google fab btn-social-icon"> </i>الاتصال <span class="d-none d-sm-inline">مع Google</span></button>
                <hr class="my-4">
                <p class="text-sm text-muted">بالتسجيل فإنك توافق على الدليل <a href="privacy.php">سياسة الخصوصية</a>.</p>
